...
public abstract class MenuManager {
    ...
    public void updateContextMenu(Menu menu, SelectionDetails selectionDetails) {
        ...
        MenuItem addLauncherShortcut = menu.findItem(R.id.action_menu_add_shortcut);
    ...
    protected void updateAddLauncherShortcut(MenuItem addLauncherShortcut, SelectionDetails selectionDetails) {
